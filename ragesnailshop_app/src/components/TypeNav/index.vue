                    ...
                    <div class="all-sort-list2">
                        <div class="item" v-for="(itemCate1,index) in categoryList" :key="itemCate1.categoryId">
                            ...
                            <div class="item-list clearfix">
                                <div class="subitem" v-for="(itemCate2,index) in itemCate1.categoryChild" :key="itemCate2.categoryId">
                                    <dl class="fore">
                                        <dt>
                                            <a href="">{{itemCate2.categoryName}}</a>
                                        </dt>
                                        <dd>
                                            <em v-for="(itemCate3, index) in itemCate2.categoryChild" :key="itemCate3.categoryId">
